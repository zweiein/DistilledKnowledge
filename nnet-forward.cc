...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    po.Read(argc, argv);
    //KALDI_ERR << "no softmax =: " << no_softmax << ",  tempurature= " << distilled_tempurature;
    ...
    /*
    KALDI_ERR << "nnet.NumComponents()= " << nnet.NumComponents() << "; Comp[0]" << nnet.GetComponent(0).GetType() 
              << "; Comp[1]" << nnet.GetComponent(1).GetType() 
              << "; Comp[2]" << nnet.GetComponent(2).GetType() 
              << "; Comp[3]" << nnet.GetComponent(3).GetType() 
              << "; Comp[4]" << nnet.GetComponent(4).GetType() 
              << "; Comp[5]" << nnet.GetComponent(5).GetType() 
              << "; Comp[6]" << nnet.GetComponent(6).GetType() 
              << "; Comp[7]" << nnet.GetComponent(7).GetType() 
              << "; Comp[8]" << nnet.GetComponent(8).GetType() 
              << "; Comp[9]" << nnet.GetComponent(9).GetType() 
              ; */
